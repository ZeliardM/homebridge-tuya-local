...
class OilDiffuserAccessory extends BaseAccessory {
  ...
  _verifyCachedPlatformAccessory(): void {
    ...
    let humidifierService = this._getServiceById(Service.HumidifierDehumidifier, 'humidifier')
    ...
    let lightService = this._getServiceById(Service.Lightbulb, 'lightbulb')
  ...
  _registerCharacteristics(dps: DPSState): void {
    ...
    const humidifierService = this._getServiceById(Service.HumidifierDehumidifier, 'humidifier')
    const lightService = this._getServiceById(Service.Lightbulb, 'lightbulb')
